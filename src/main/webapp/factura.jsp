...
<div class="container">
    <section>
        <div class = "row">
            <div class="col-md-6 text-center mt-2 fs-5">
                <p class="font-weight-bold mb-1">Generador Factura 2022</p>
                <p class="font-weight-bold mb-1">Ignacio Car Ltda.</p>
                <p class="text-muted">Año 2022 Octubre.</p>
            </div>
        </div>
    </section>
    <div class="row">
                ...
                <div class="card-body p-0">
                    <div class="row p-5">
                        <div class="col-md-auto">
                            <img class="img-fluid" alt="Responsive banner"
                                    src="img/Banner.png">
                        </div>
                    </div>
